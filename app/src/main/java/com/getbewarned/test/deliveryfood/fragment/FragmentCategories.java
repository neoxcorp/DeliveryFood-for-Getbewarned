...
public class FragmentCategories extends Fragment {
    ...
    private void init(View view) {
        ...
        activityFood.setTitle("Categories");

        categoryItems.addAll(DataManager.getCategories());
